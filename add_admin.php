...
<script src="js/add_adminUname.js"></script>
<div class="form">
    ...
    <form action="" method="post" onsubmit="return validate()" enctype="multipart/form-data">
      ...
      <table align="center">
        ...
        <tr>
          <td>Username</td>
          <td>: <input id="username" type="text" name="username" onfocusout="checkAdminUname(this)" value="<?php echo $uname;?>" ><br>
        ...
        <tr>
          <td></td>
           <td align="center"><input class="btn_edit" type="submit" name="add_admin" value="Add Admin" ></td>
        </tr>
