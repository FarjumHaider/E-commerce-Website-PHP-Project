...
<!-- style="background-color:#f4f5f7;" -->
  ...
  <a class="btn_edit" style="text-decoration: None;" href="add_product.php" > Add Product </a><br><br>
      <input class="search_bar" type="text"  onkeyup="searchProduct(this)" placeholder="Search...">
          ...
          <?php
            ...
            foreach ($products as $p) {
              ...
              echo "<tr>";
                ...
                echo'<td> <a class="btn_edit" href="edit_product.php?id='.$p["id"].'">Edit</a>';
                echo'<a  class="btn_delete" href="delete_product.php?id='.$p["id"].'">Delete</a></td>';
