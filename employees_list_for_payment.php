...
$employees = getAllEmployees();
 ...
 <div class="table-body">
   ...
   <script src="js/search_salary.js"></script>
    ...
    <input class="search_bar" class="search_bar" type="text"  onkeyup="searchSalary(this)" placeholder="Search...">
   ...
   <?php
     ...
     foreach ($employees as $e) {
       ...
       echo "<tr>";
         ...
         echo'<td> <a class="btn_edit" href="paying_salary.php?id='.$e["id"].'">Pay</a></td>';
