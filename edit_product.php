...
<div class="form">
      ...
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <table align="center">
          ...
          <tr>
            <td>
             <input name="id" value="<?php echo $p["id"];?>" type="hidden">
					...
					<tr>
						<td>Product name</td>
						<td>: <input type="text" name="pname" value="<?php echo $p["name"];?>" ><br>
						<span style="color:red;"><?php echo $err_pname;?></span></td>
					</tr>
          ...
          <tr>
            <td></td>
             <td align="center"><input class="btn_edit" type="submit" name="edit_product" value="Edit Product" ></td>
          </tr>
