...
$admin = getAllAdmin();
 ...
 <div class="table-body">
    <script src="js/search_admin.js"></script>
      <a class="btn_edit" style="text-decoration: None;" href="add_admin.php" > Add Admin </a><br><br>
     <input class="search_bar" type="text"  onkeyup="searchAdmin(this)" placeholder="Search...">
